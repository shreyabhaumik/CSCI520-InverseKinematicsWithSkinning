...
public:
  ...
  void applySkinning(const RigidTransform4d * jointSkinTransforms, double * newMeshVertexPositions, FK * fk, int SkinningMethod) const; // added FK * fk to do Dual Quaternion Skinning
